export default function StatsCard({ label, value, highlight }) {
  return (
    <div className={`rounded-xl p-3 sm:p-4 text-center shadow-sm border transition-all ${
      highlight 
      ...
      <p className={`text-2xl sm:text-3xl font-bold mt-1 ${highlight ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
        {value}
      </p>
    </div>
  );
